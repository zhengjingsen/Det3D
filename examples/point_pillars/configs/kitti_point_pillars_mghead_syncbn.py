...
db_sampler = dict(
    type="GT-AUG",
    enable=True,
    db_info_path="/media/jingsen/zhengjs/Datasets/kitti_object/dbinfos_train.pkl",
...
train_anno = "/media/jingsen/zhengjs/Datasets/kitti_object/kitti_infos_train.pkl"
val_anno = "/media/jingsen/zhengjs/Datasets/kitti_object/kitti_infos_val.pkl"
test_anno = None
