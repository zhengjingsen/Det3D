...
# Voxelnet
#python -m torch.distributed.launch --nproc_per_node=1 ./tools/train.py examples/second/configs/kitti_car_vfev3_spmiddlefhd_rpn1_mghead_syncbn.py --work_dir=$SECOND_WORK_DIR
